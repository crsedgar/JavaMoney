package uk.org.cobaltdevelopment.training.money;
...
public class MoneyTest {
	...
	public void simpleArithmetic() {
		Money oneEuro = Money.of(1, "EUR");
		assertTrue(Money.of(3, "EUR").equals(Money.of(2, "EUR").add(oneEuro)));
		assertTrue(Money.of(2, "EUR").equals(Money.of(3, "EUR").subtract(oneEuro)));
	...
	public void givenAmounts_whenSummed_thanCorrect() {
		MonetaryAmount[] monetaryAmounts = new MonetaryAmount[] { Money.of(100, "CHF"), Money.of(10.20, "CHF"),
				Money.of(1.15, "CHF") };
	...
	@Ignore("conversion need addiitonal configuration")
	@Test
